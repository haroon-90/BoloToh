...
const Main = () => {
  ...
  return (
    <div className="p-4 flex flex-col justify-center items-center min-h-[calc(100vh-152px)] mx-10 my-3 gap-2">
          <h2 className="text-2xl font-bold mb-4">What would you like to generate?</h2>
          <div className="space-x-4 mb-6 flex justify-center flex-wrap gap-2">
            <button onClick={() => {setSelectedTask('poem') }} className="bg-blue-500 text-white px-4 py-2 rounded min-w-10 w-40">Poem</button>
            <button onClick={() => {setSelectedTask('Motivation') }} className="bg-green-500 text-white px-4 py-2 rounded min-w-10 w-40">Motivation</button>
            ...
            <button onClick={() => {setSelectedTask('advice') }} className="bg-blue-500 text-white px-4 py-2 rounded min-w-10 w-40">AI Advice</button>
          </div>
